...
dict = {'サーモンピンク':[250,114,128],'赤':[255,0,0],'ダークレッド':[139,0,0],'ピンク':[255,192,203],
        'ホットピンク':[255,105,180],'コーラル':[255,1127,80],'オレンジ':[255,165,0],'ゴールド':[255,125,0],
        '黄色':[255,255,0],'カーキ':[240,230,140],'ライムグリーン':[50,205,50],'緑':[0,128,0],
        '深緑':[0,100,0],'黄緑':[154,205,50],'オリーブ':[128,128,0],'ターコイズ':[64,224,208],
        '水色':[135,206,135],'ロイヤルブルー':[65,105,225],'青':[0,0,255],'ネイビー':[0,0,128],
        'ラベンダー': [230,230,250],'パープル':[128,0,128],'インディゴ':[75,0,130],'ブラウン':[165,42,42],
        '白':[255,255,255],'ベージュ':[245,245,220],'アイボリー':[255,255,240],'シルバー':[192,192,192],
